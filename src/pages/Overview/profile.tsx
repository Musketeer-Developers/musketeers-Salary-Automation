          ...
          <Col xs={{ span: 24 }} xl={{ span: 8 }}>
            ...
            >
              ...
              <ShowTextAndIcon
                ...
                placeholder={person.hubstaffEnabled || "Hubstaff Status"}
              ...
              <ShowTextAndIcon
                ...
                placeholder={person.grossSalary || "99,999"}
                icon={<DollarOutlined />}
                variant="text"
                loading={false}
              />
              ...
              <ShowTextAndIcon
                ...
                placeholder={person.permanentDate || "DD MM YYYY"}
                icon={<CalendarOutlined />}
                variant="text"
                loading={false}
              />
              ...
              <ShowTextAndIcon
                ...
                placeholder={person.lastWorkingDay || "DD MM YYYY"}
                icon={<CalendarOutlined />}
                variant="text"
                loading={false}
              />
