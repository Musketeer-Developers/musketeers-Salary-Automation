    ...
    try {
      const response = await axios.post(
        ...
        JSON.stringify(formattedData),
        {
          headers: {
            Authorization:
              "Bearer ",
            "Content-Type": "application/json",
          },
        }
      );
        ...
        >
          ...
          >
            <Input
              ...
              maxLength={12}
            />
            <span style={{ marginLeft: "5px", fontSize: "small" }}>
          ...
          <Form.Item
            name="hubstaffEnabled"
            label="Hubstaff Enabled"
